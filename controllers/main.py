...
class creditlimit(http.Controller):
    ...
    def contact(self, **kwargs):
        values = {}
        for field in ['credit_limit', 'partner_name', 'phone', 'contact_name', 'email_from', 'name']:
            if kwargs.get(field):
    ...
    def creditlimit(self, **kwargs):
        ...
        _REQUIRED = ['name', 'contact_name', 'email_from', 'credit_limit']  # Could be improved including required from model
